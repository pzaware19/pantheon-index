...
def build():
    ...
    payload["meta"] = {
        ...
        "method_note": (
            "Dominance is each star's mean z-score across five pillars, measured "
            "against a curated set of era peers within their own sport (the Gould "
            "normalization), so units cancel and 'SDs above peers' means the same "
            "thing in cricket, football and tennis. Elegance is an aesthetic-lexicon "
            "density over a curated commentary/press corpus, scaled to 100."
        ),
